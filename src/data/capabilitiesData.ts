...
export const ROLE_PRESET_TEMPLATES: RolePresetTemplate[] = [
  ...
  {
    name: 'Sales & Corporate Setup Specialist',
    roleType: 'employee',
    description: 'Specializes in corporate client acquisition, trade license registration, company setups, branches, and prospect conversion.',
    color: '#0EA5E9',
    permissions: {
      canCreateClients: true,
      canCreateClient: true,
