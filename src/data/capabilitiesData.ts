...
export const SYSTEM_CAPABILITIES: CapabilityDefinition[] = [
  ...
  },
  {
    ...
    label: 'Create & Manage Legal Entities',
    category: 'Multi-Branch & Governance',
    description: 'Allows registering and configuring legal corporate entities, Trade Licenses, TRNs, and official corporate seals.',
    technicalScope: 'Grants access to Company Settings, branch creation, official stamp uploads, and trade license tracking.',
    riskLevel: 'Critical Admin',
    recommendedFor: ['master'],
  },
  {
